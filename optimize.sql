...
CREATE INDEX IF NOT EXISTS idx_course_bookings_classTable ON course_bookings (user_id, cancelled_at);
...
CREATE INDEX IF NOT EXISTS idx_course_end_at ON courses (end_at);
...
CREATE INDEX IF NOT EXISTS idx_course_bookings_classTable 
